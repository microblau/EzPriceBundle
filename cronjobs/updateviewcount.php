...
if ( is_file( $logFilePath ) )
{
    ...
    {
        $cli->output( "Warning: Cannot open nginx log-file '$logFilePath' for reading, please check permissions and try again." );
    }
}
else
{
    $cli->output( "Warning: nginx log-file '$logFilePath' doesn't exist, please check your ini-settings and try again." );
}

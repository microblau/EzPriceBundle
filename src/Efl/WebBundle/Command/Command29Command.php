 ...
 */
class Command29Command extends ContainerAwareCommand
{
    protected function configure()
    {
        $this->setName( 'efl:web:command29' )->setDefinition(array());
    }
    ...
    protected function execute( InputInterface $input, OutputInterface $output )
    {
        ...
        try
        {
            $contentInfo = $contentService->loadContentInfo( 20025 );
            ...
            $contentUpdateStruct->setField( 'url_youtube', "http://www.youtube.com/embed/zOwWqWusi64?rel=0&amp;amp;autoplay=1");
            $contentUpdateStruct->setField( 'img_preview_video', new Value( $img1 ) );
            $contentUpdateStruct->setField( 'img_preview_video_2', new Value( $img2 ) );

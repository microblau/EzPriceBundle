...
class eZCustomDiscountSubRule extends eZPersistentObject
{
    /*!
     Constructor
    */
    function eZCustomDiscountSubRule( $row )
    {
    ...
    static function definition()
    {
        return array( "fields" => array( "id" => array( 'name' => 'ID',
                      ...
                      "keys" => array( "id" ),
                      "increment_key" => "id",
                      "class_name" => "eZCustomDiscountSubRule",
                      "name" => "ezcustomdiscountsubrule" );
    }
    ...
    {
        return eZPersistentObject::fetchObject( eZCustomDiscountSubRule::definition(),
                                                null,
                                                array( "id" => $id ),
                                                $asObject );
    }
    ...
    {
        return eZPersistentObject::fetchObjectList( eZCustomDiscountSubRule::definition(),
                                                    null, null, null, null,
                                                    $asObject );
    }
    ...
    static function create( $discountRuleID )
    {
        $row = array(
            ...
            "discount_percent" => "",
            "limitation" => "*" );
        return new eZCustomDiscountSubRule( $row );
    }
    ...
    {
        eZPersistentObject::removeObject( eZCustomDiscountSubRule::definition(),
                                          array( "id" => $id ) );
    }
}
?>

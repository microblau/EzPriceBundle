...
{/if}
                        	...
                        	<form method="post" id="datosLoginForm" action={"/colectivos/login/"|ezurl} name="loginform">
...
<input type="hidden" name="RedirectURI" value={"catalogo/sector/colectivo-asociacion-profesional"|ezurl} />

...
//
// Created on: <15-Feb-2010 16:35:14 carlos.revillo@tantacom.com>
//
...
/*!
  \class eZTextColorType eztextcolortype.php
  \ingroup eZDatatype
  \brief Datatipo que permite seleccionar color de forma sencilla.

  Funciona de forma casi idéntica a una cadena de texto normal
  
*/

require_once( 'kernel/common/i18n.php' );

class eZTextColorType extends eZDataType
{
    const DATA_TYPE_STRING = 'eztextcolor';
    ...
    */
    function eZTextColorType()
    {
        $this->eZDataType( self::DATA_TYPE_STRING, ezpI18n::tr( 'kernel/classes/datatypes', 'Color', 'Datatype name' ),
...
eZDataType::register( eZTextColorType::DATA_TYPE_STRING, 'eZTextColorType' );

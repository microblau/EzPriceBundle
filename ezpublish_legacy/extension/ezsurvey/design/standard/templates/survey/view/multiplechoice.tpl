<label><span style="font-size:1.2em">{$question.text|wash('xhtml')}</span> {switch match=$question.num}{case match=1}<strong class="required">*</strong>{/case}{case match=2}<strong class="required">*</strong>{/case}{/switch}</label>

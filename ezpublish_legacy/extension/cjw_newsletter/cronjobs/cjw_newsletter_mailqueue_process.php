 ...
 * @version 1.0.0beta2 | $Id: cjw_newsletter_mailqueue_process.php 12235 2010-07-02 08:17:28Z felix $
...
$tpl = templateInit();
$template = 'design:newsletter/skin/efl/outputformat/html.tpl';

$about_materia = $newsletterUserObject->attribute( 'about_materia' );
$tpl->setVariable('materias', explode( '-', $about_materia ) );

$about_info = $newsletterUserObject->attribute( 'about_info' );
$tpl->setVariable('info', $about_info );

$hash=$newsletterSubscriptionObject->attribute('hash');
$tpl->setVariable('hash',$hash);

$cont = (int) $sendObject->attribute( 'edition_contentobject_id' ) ;
$tpl->setVariable('cont',$cont);

$version = (int) $sendObject->attribute( 'edition_contentobject_version' ) ;

$contentObject = eZContentObjectVersion::fetchVersion( $version ,$cont );
$tpl->setVariable('contentobject', $contentObject );




$outputStringArrayNew[ 'html' ] = $tpl->fetch( $template );

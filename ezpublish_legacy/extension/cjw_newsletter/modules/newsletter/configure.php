 ...
 * @version 1.0.0beta2 | $Id: configure.php 12592 2010-07-27 13:56:13Z felix $
...
$ebookquery = $db->arrayQuery( "SELECT ebook FROM ebooks_regalo WHERE hash = '" . $Params['UserHash'] . "'" );

$tpl->setVariable( 'ebook', $ebookquery[0]['ebook'] );

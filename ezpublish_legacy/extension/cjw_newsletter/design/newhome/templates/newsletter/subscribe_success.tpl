				...
				<div class="columnType1">
					<div id="modType2">
							...
							<div class="wrap clearFix">                    		
								...
								<div class="contacte" >
								<p style="margin-bottom:10px">El formulario se ha enviado correctamente.</p>
                                <p>En breve recibira un email a la dirección que nos ha proporcionado. Para activar sus suscripción deberá confirmar el email que le hemos enviado.</p>
								</div>

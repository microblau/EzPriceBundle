        					...
        					<table cellpadding="0" cellspacing="0" width="584" border="0">
        						<tr>
                                    ...
                                    {$texto}
                                        ...
                                        <!-- enlaces sociales -->
        												<tr>
                                            	<td colspan="2" align="left"><a href="http://www.linkedin.com/shareArticle?mini=true&url={concat( $inicio, "/", $destacado.url_alias )}
 Enviado a la(s) "><img src={concat( $images, "images/btn_ln.gif")} alt="compartir en linkedin" border="0" /></a> <a href="http://twitter.com/share?url={concat( $inicio, "/", $destacado.url_alias )}&text={$destacado.name}"><img src={concat( $images, "images/btn_twit.gif")}  alt="compartir en twitter" border="0" /></a> {*<a href=""><img src={concat( $images, "images/btn_g.gif")}  alt="compartir en google plus" border="0" /></a>*} <a href="http://www.facebook.com/share.php?u={concat( $inicio, "/", $destacado.url_alias )}"><img src={concat( $images, "images/btn_f.gif")}  alt="me gusta" border="0" /></a></td>
                                            </tr>
                                  ...
                                  <strong>	{$node.data_map.precio.content.discount_price_ex_vat|l10n(clean_currency)}  € </strong>+ IVA</span>
                                   {/if}
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" border="0" width="114">
	        												...
	        												<tr><td height="5" style="font-family: Arial, Helvetica, sans-serif; line-height: 1px; font-size: 1px">&nbsp;</td></tr>	
                     				                       <tr> <td align="right"><a href="http://www.linkedin.com/shareArticle?mini=true&url={concat( $inicio, "/", $producto.url_alias )}
 Enviado a la(s) "><img src={concat( $images, "images/btn_ln.gif")}  alt="compartir en linkedin" border="0" /></a></td> </tr>
                     				                       <tr><td height="5" style="font-family: Arial, Helvetica, sans-serif; line-height: 1px; font-size: 1px">&nbsp;</td></tr>
                     				                       <tr> <td align="right"><a href="http://twitter.com/share?url={concat( $inicio, "/", $producto.url_alias )}&text={$producto.name}"><img src={concat( $images, "images/btn_twit.gif")}  alt="compartir en twitter" border="0" /></a></td> </tr>
                     				                       {*<tr><td height="5" style="font-family: Arial, Helvetica, sans-serif; line-height: 1px; font-size: 1px">&nbsp;</td></tr>
                     				                       <tr> <td align="right"><a href=""><img src={concat( $images, "images/btn_g.gif")}  alt="compartir en google plus" border="0" /></a></td> </tr>*}
                     				                       <tr><td height="5" style="font-family: Arial, Helvetica, sans-serif; line-height: 1px; font-size: 1px">&nbsp;</td></tr>
                     				                       <tr> <td align="right"><a href="http://www.facebook.com/share.php?u={concat( $inicio, "/", $producto.url_alias )}"><img src={concat( $images, "images/btn_f.gif")} alt="me gusta" border="0" /></a></td> </tr>
...
<tr>
    <td><script src="http://www.efl.es/x.gif?hash={$hash}&id={$cont}"></script></td>
</tr> 
</table>  

...
<ul>
	...
	{* Metadata. *}
    {section show=ezpreference( 'admin_navigation_metadata' )}
    <li class="enabled {$li_width}">
    <div class="button-bc"><div class="button-tl"><div class="button-tr"><div class="button-br">
        <a href={'/user/preferences/set/admin_navigation_metadata/0'|ezurl} title="{'Hide object meta data overview.'|i18n( 'design/admin/node/view/full' )}">{'Meta Data'|i18n( 'design/admin/node/view/full' )}</a>
    </div></div></div></div>
    </li>
    {section-else}
    <li class="disabled {$li_width}">
    <div class="button-bc"><div class="button-tl"><div class="button-tr"><div class="button-br">
        <a href={'/user/preferences/set/admin_navigation_metadata/1'|ezurl} title="{'Show object meta data overview.'|i18n( 'design/admin/node/view/full' )}">{'Meta Data'|i18n( 'design/admin/node/view/full' )}</a>
    </div></div></div></div>
    </li>
    {/section}

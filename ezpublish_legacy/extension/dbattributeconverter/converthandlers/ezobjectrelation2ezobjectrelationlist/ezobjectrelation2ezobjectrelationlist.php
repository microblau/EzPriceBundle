<?php
// Created on: <19-Jul-2009 16:30 bm>
//
...
class ezobjectrelation2ezobjectrelationlist extends convertHandler
{
	var $from_datatype	= 'ezobjectrelation';
	var $to_datatype	= 'ezobjectrelationlist';
	...
	{
		$content = $contentObjectAttribute->attribute( 'data_int' ); 

 <div id="navBar">
            <ul>
                ...
                <li {if and( is_set( ezpagedata().persistent_variable.menuoption ),  ezpagedata().persistent_variable.menuoption|eq( 3 ) ) }class="sel"{/if}><a href={"formacion"|ezurl}>Formación</a>
                    <ul>
                ...
                <li><a href="">Por qué Lefebvre</a></li>
                <li class="buscador"><a href="">Buscadores</a></li>
            </ul>
        </div>

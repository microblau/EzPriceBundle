...
<div id="commonGrid" class="clearFix">
                ...
                <div id="subNavBar">
                    ...
                    <ul>
                        {include uri='design:formacion/menu.tpl' check=$nodefrom actual=$param2 hijo=$param3}              
                    </ul>
                ...
                {def $nodoActual=fetch('content','node',hash('node_id',$nodos[concat($param1,'_',$param3)]))}
                ...
                <div id="content">
                        ...
                        <div id="novedades">
                               ...
                               {def $elements_count = fetch('content','tree_count', hash('parent_node_id', $nodos[concat($param1,'_',$param3)]|int,
                                ...
                                <div class="description busquedaCursos">
                                    <ul class="wrapAjaxContent clearFix">
                                        {switch match=$order_by }
                                            {case match='precio'}
                                                {def $sort_array = array( 'attribute', true(), concat($clases[$param1],'/precio'))}
                                            {/case}
                                            {case match='fechainicio'}
                                                {def $sort_array = array( 'attribute', false(), concat($clases[$param1],'/fecha_inicio'))}
                                            {/case}
                                            {case}
                                                {def $sort_array = array( 'attribute', false(), concat($clases[$param1],'/fecha_inicio'))}
                                            {/case}
                                        {/switch}
                                         ...
                                         {def $elements = fetch('content','list', hash('parent_node_id', $nodos[concat($param1,'_',$param3)]|int,
                                                                                        'class_filter_type','include',
                                                                                        'class_filter_array', array($clases[$param1]),
                                                                                        'sort_by', $sort_array,                                                                                     
         ...
         page_uri=concat( 'formacion/', $param1, '/', $param2, '/', $param3 )

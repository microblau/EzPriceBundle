...
<div id="commonGrid" class="clearFix">
                ...
                <div id="subNavBar">
                    ...
                    <ul>
                        ...
                        {include uri='design:formacion/menu.tpl' check=$node.parent actual=fetch( 'content', 'list', hash( 'parent_node_id', $node.parent.node_id,
                                                                                                                            'attribute_filter', array( array( 'name', '=', 'Por rama del Derecho' ) )
                                    ...
                                    <ul class="wrapAjaxContent clearFix">
                                         ...
                                         {foreach $elements as $index => $element}
                                            ...
                                            {foreach $element.object.assigned_nodes as $n}
                                                ...
                                                {/if}    
                                            {/foreach}
                                            {node_view_gui content_node=$nodetoshow view=line reset=$index|eq( $elements|count|sub(1) ) nodefrom=$node.node_id}
                                         {/foreach}

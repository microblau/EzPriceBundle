  ...
  <div class="msgError">
   ...
   {else}
     ...
     <li>
      ...
      <input class="text" type="text" name="email" tabindex="1"  value="{$wrong_email|wash}" /></li>
      </ul>

      <span class="submit">
      <input type="image" src={"btn_aceptar.gif"|ezimage} name="BtnPasswordRecover" value="{'Generate new password'|i18n('design/standard/user/forgotpassword')}" />
      </span>
      </form>
      {/if}
   {/if}

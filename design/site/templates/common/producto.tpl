...
>Volver al listado</a></span>
                            <ul class="tabs">
                 				<li {if array( 'producto', 'ventajas_producto' )|contains( $clase )}class="sel"{/if}>
                              {if array( 'producto', 'ventajas_producto' )|contains( $clase )}<h2>{else}<a href="{fetch( 'content', 'list', hash( 'parent_node_id', $node.node_id,
                                                'class_filter_type', 'include',
                                                'class_filter_array', array( 'ventajas_producto' )
 )).0.url_alias|ezurl(no)}#producttext">{/if}Ventajas{if array( 'producto', 'ventajas_producto' )|contains( $clase )}</h2>{else}</a>{/if}
                                </li>
...
{/if}
                            ...
                            <div class="cont cursoDet clearFix">
                            	...
                            	{else}
                                <div class="column1">
									{if array( 'producto', 'ventajas_producto' )|contains( $clase )}

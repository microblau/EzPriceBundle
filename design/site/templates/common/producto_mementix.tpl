 ...
 {def $discount_type = fetch( 'basket', 'get_discount_type', hash( 'user', fetch( 'user', 'current_user' ),																                                                      'params', hash( 'contentclass_id', $node.object.contentclass_id,
                                         ...
                                         <div class="ofertaSus">
                                            ...
                                            <div>
                                                <div class="precioAnterior">
                                                    <span><s>{$node.data_map.precio.content.price|l10n(clean_currency)} € + IVA
                                                    </s></span>
                                                </div>
                                                <div>
                                                    {$node.data_map.precio_oferta.content.price|l10n(clean_currency)} € + IVA
                                                </div>
                                            </div>
                                        ...
                                        {else}
                                             <div class="ofertaSus">
                                             	<div>
                                                	<div class="precioAnterior">
                                                    	<span>{$node.data_map.precio.content.price|l10n(clean_currency)} € + IVA</span>
                                                    </div> 
                                                </div>
                                              </div>
                                    	{/if}
                                           ...
                                           {def $havotado=fetch('producto','havotado' , hash( 'node_id', $node.node_id , 'usuario',$user_id ))} 
											...
											{if $current_user.is_logged_in}
                                             ...
                                             {else}
                                             	 ...
                                             	 <a href={concat("/producto/login/(opinion)/, $node.object.id)|ezurl(no)}" id="formOpinion"><img src={"btn_opine.png"|ezimage()} alt="Opine sobre esta obra" /></a>
                                           ...
                                           {def $havotado=fetch('producto','havotado' , hash( 'node_id', $node.node_id , 'usuario',$user_id ))} 
											...
											{if $current_user.is_logged_in}
                                             ...
                                             {else}
                                             	 ...
                                             	 <a href={concat("/producto/login/(opinion)/", $node.object.id)|ezurl} id="formOpinion"><img src={"btn_opine.png"|ezimage()} alt="Opine sobre esta obra" /></a>

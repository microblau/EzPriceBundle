...
>Volver al listado</a></span>
                            <ul class="tabs ">
                                ...
                                <li {if and(is_set( $view_parameters.info), $view_parameters.info|eq('programa') )}class="sel"{/if}>
                                    {if and(is_set( $view_parameters.info), $view_parameters.info|eq('programa') )}<h2>{else}<a href="{concat($node.url_alias, '/(info)/programa')|ezurl(no)}{if is_set($view_parameters.cursos)}/(cursos)/{$view_parameters.cursos}{/if}#cursoDetalle">{/if}Programa{if and(is_set( $view_parameters.info), $view_parameters.info|eq('programa') )}</h2>{else}</a>{/if}
                                </li>
                                {/if}
                                ...
                                <li {if and(is_set( $view_parameters.info), $view_parameters.info|eq('metodologia') )}class="sel"{/if}>
                                    {if and(is_set( $view_parameters.info), $view_parameters.info|eq('metodologia') )}<h2>{else}<a href="{concat($node.url_alias, '/(info)/metodologia')|ezurl(no)}{if is_set($view_parameters.cursos)}/(cursos)/{$view_parameters.cursos}{/if}#cursoDetalle">{/if}Metodología{if and(is_set( $view_parameters.info), $view_parameters.info|eq('metodologia') )}</h2>{else}</a>{/if}
                                </li>
                                {/if}
                                
                                {if $node.data_map.tutorias.has_content}
                                <li {if and(is_set( $view_parameters.info), $view_parameters.info|eq('tutorias') )}class="sel"{/if}>
                                    {if and(is_set( $view_parameters.info), $view_parameters.info|eq('tutorias') )}<h2>{else}<a href="{concat($node.url_alias, '/(info)/tutorias')|ezurl(no)}{if is_set($view_parameters.cursos)}/(cursos)/{$view_parameters.cursos}{/if}#cursoDetalle">{/if}Tutorías{if and(is_set( $view_parameters.info), $view_parameters.info|eq('tutorias') )}</h2>{else}</a>{/if}
                                </li>
                                {/if}
                                
                                {if $node.data_map.materiales.has_content}
                                <li {if and(is_set( $view_parameters.info), $view_parameters.info|eq('materiales') )}class="sel"{/if}>
                                    {if and(is_set( $view_parameters.info), $view_parameters.info|eq('materiales') )}<h2>{else}<a href="{concat($node.url_alias, '/(info)/materiales')|ezurl(no)}{if is_set($view_parameters.cursos)}/(cursos)/{$view_parameters.cursos}{/if}#cursoDetalle">{/if}Materiales{if and(is_set( $view_parameters.info), $view_parameters.info|eq('materiales') )}</h2>{else}</a>{/if}
                                </li>
                                {/if}
                                
                                {if $node.data_map.duracion.has_content}
                                <li {if and(is_set( $view_parameters.info), $view_parameters.info|eq('duracion') )}class="sel"{/if}>
                                    {if and(is_set( $view_parameters.info), $view_parameters.info|eq('duracion') )}<h2>{else}<a href="{concat($node.url_alias, '/(info)/duracion')|ezurl(no)}{if is_set($view_parameters.cursos)}/(cursos)/{$view_parameters.cursos}{/if}#cursoDetalle">{/if}Duración{if and(is_set( $view_parameters.info), $view_parameters.info|eq('duracion') )}</h2>{else}</a>{/if}
                                </li>
                                {/if}
                            </ul>
                            </div>
                            <div class="cont cursoDet clearFix">
                                ...
                                <div class="column1">
                                    ...
                                    {elseif and(is_set($view_parameters.info), $view_parameters.info|eq('programa'))}
                                       {*<h2>Programa</h2>*}
                                    ...
                                    {elseif and(is_set($view_parameters.info), $view_parameters.info|eq('tutorias'))}
                                       {*<h2>Tutorías</h2>*}
                                       {$node.data_map.tutorias.content.output.output_text}
                                    {elseif and(is_set($view_parameters.info), $view_parameters.info|eq('materiales'))}
                                       {*<h2>Materiales</h2>*}
                                       {$node.data_map.materiales.content.output.output_text}
                                    {elseif and(is_set($view_parameters.info), $view_parameters.info|eq('duracion'))}
                                       {*<h2>Duración</h2>*}

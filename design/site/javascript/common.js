...
var behaviours = {
        ...
        controlHeight2:function(obj, obj2){
                ...
                if( hObj > hObj2){
                        obj2.css ({"height" : hObj + "px" });
                }else{
                        obj.css ({"height" : hObj2 + "px" });
                }
        },
...
var AjaxRequest = {
        ...
        destacadoHome:{
                ...
                action:function(obj){
                        AjaxRequest.load3 (AjaxRequest.destacadoHome.content,obj.attr("href"));
                }
        },
        modsGenericHome:{
                content:null,
...
jQuery(document).ready(function() {    
    ...
    /*
        ...
        if($("#home #gridHome2 #modDestacado").length != 0 && $("#home #gridHome2 #modActum").length != 0) {
                behaviours.controlHeight2($("#home #gridHome2 #modDestacado"), $("#home #gridHome2 #modActum"));       
        }
	...
	*/
		...
		if($("#footer .mediosPago").length != 0){
			$('#footer .mediosPago').corner({
				tl: { radius: 7 }, tr: { radius: 7 }, bl: { radius: 7 }, br: { radius: 7 }, antiAlias: true 
			});
		}

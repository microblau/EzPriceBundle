...
<select name="{$attribute_base}_ezselect_selected_array_{$attribute.id}[]" {if $attribute.class_content.is_multiselect}multiple="multiple"{/if} id="{$attribute_base}_ezselect_selected_array_{$attribute.id}[]">

    ...
    <div class="wysiwyg">
     ...
     <div class="action">
                                                ...
                                                <div class="difPrecios">
                                                    ...
                                                    {/if}
                                                    <span class="ahora{if $node.data_map.precio.content.has_discount|not} soloPrecio{/if}">Ahora <span>{if $node.data_map.precio.content.has_discount}{$node.data_map.precio.content.discount_price_ex_vat|round()}{else}{$node.data_map.precio.content.price|round()}{/if} €</span></span>
                                                </div>
                                                {/if}
                                                {if $nodefrom|eq(74)}

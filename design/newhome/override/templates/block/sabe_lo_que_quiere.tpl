 ...
 <h2>{$block.custom_attributes.titulo}</h2>
                    <div class="wrap clearFix">
                        <div class="modTambien modAbonados">
                            <div id="modSoyAbonado" class="module">
                                <h3>Soy abonado</h3>
                                <p>Acceda a sus productos y servicios</p>
                                <span class="verMas"><a target="_blank" href="http://acceso.qmemento.com/welcome.do?forward=qmemento">QMemento</a></span>

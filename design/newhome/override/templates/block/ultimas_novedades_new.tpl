<ul id="tabsNov">
                        		<li><h3>Novedades</h3></li>
                        		<li><a href="">Las + compradas</a></li>
                        		<li><a href="">Las + consultadas</a></li>
                        	</ul>
                        <div id="modNovedades">
                            ...
                            <div class="carrousel">
                            	{def $products = fetch( 'content', 'tree', hash( 
                            												...
                            												'attribute_filter', array( array( 'producto/fecha_aparicion', 'between', array( currentdate()|sub( 86400|mul(270) ), currentdate() ) ) )
                            	))}

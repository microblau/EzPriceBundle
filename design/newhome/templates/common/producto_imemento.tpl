					...
					<div class="tryPromo">
                        ...
                        <form id="frm_tryImemento" action={"content/action"|ezurl} method="post">
							...
							<span class="requiredText">* Datos obligatorios</span>
									...
									<label class="check" for="legal"> <input type="checkbox"id="legal" name="ContentObjectAttribute_data_boolean_244860" /> Acepto las <a id="condicionesligthBox" href={'lightbox/ver/1451'|ezurl}>condiciones legales</a></label>
...
{def $tabscount = 1}
                    	...
                    	<div class="descripcion" id="producttext">
                            <ul class="tabs" style="float:none">
                            	<li {if and( array( 'producto_imemento', 'ventajas_producto' )|contains( $clase ), is_set( $view_parameters.v)|not )}class="sel"{/if}>
                              {if and( array( 'producto_imemento', 'ventajas_producto' )|contains( $clase ), is_set( $view_parameters.v)|not )}<h2>{else}<a href="{fetch( 'content', 'list', hash( 'parent_node_id', $node.node_id,
                                                'class_filter_type', 'include',
                                                'class_filter_array', array( 'ventajas_producto' )
 )).0.url_alias|ezurl(no)}#producttext">{/if}Ventajas{if and( array( 'producto_imemento', 'ventajas_producto' )|contains( $clase ), is_set( $view_parameters.v)|not )}</h2>{else}</a>{/if}
                                </li>
                            ...
                            <div class="cont cursoDet clearFix">
                                ...
                                <div class="column1">
									...
									{elseif array( 'producto_imemento', 'ventajas_producto' )|contains( $clase )}

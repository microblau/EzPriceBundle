{set-block scope=root variable=subject}Formulario de Inscripción RPSM{/set-block}
...
{append-block scope=root variable=email_bcc_receivers}breton@efl.es{/append-block}

 ...
 * @version 1.0.0beta2 | $Id: function_definition.php 12468 2010-07-13 16:21:30Z felix $
...
$FunctionList['ebook_by_hash'] = array( 'name' => 'ebook_by_hash',
                                        'operation_types' => array( 'read' ),
                                        'call_method' => array('include_file' =>'extension/cjw_newsletter/modules/newsletter/cjwnewsletterfunctioncollection.php',
                                                      'class' => 'CjwNewsletterFunctionCollection',
                                                      'method' => 'fetchEbookByHash' ),
                                        'parameter_type' => 'standard',
                               'parameters' => array(
                                                      array( 'name' => 'hash',
                                                             'type' => 'string',
...
$FunctionList['emails_opened'] = array( 'name' => 'emails_opened',
                                        'operation_types' => array( 'read' ),
                                        'call_method' => array('include_file' =>'extension/cjw_newsletter/modules/newsletter/cjwnewsletterfunctioncollection.php',
                                                      'class' => 'CjwNewsletterFunctionCollection',
                                                      'method' => 'emailsOpened' ),

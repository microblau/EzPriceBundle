 ...
 * @version 1.0.0beta2 | $Id: user_view.php 10958 2010-03-30 13:39:59Z felix $
...
if ( $http->hasPostVariable( 'about_info' ) )
{

    $subscriptionDataArr['about_info'] = trim( $http->postVariable( 'about_info' ) );
    $newsletterUserObject->setAttribute( 'about_info', $subscriptionDataArr['about_info'] );
}
if ( $http->hasPostVariable( 'about_materia' ) )
{

    $subscriptionDataArr['about_materia'] = trim( $http->postVariable( 'about_materia' ) );
    $newsletterUserObject->setAttribute( 'about_materia', $subscriptionDataArr['about_materia'] );
}

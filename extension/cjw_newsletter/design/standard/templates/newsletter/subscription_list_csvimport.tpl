...
{/if}
                        <div class="break">
                            ...
                            {'First row is label'|i18n( 'cjw_newsletter/subscription_list_csvimport')}
                                ...
                                <pre>email;first_name;last_name;actividad;about_info;about_materia
user3@example.com;Julia;Mustermann;actividad;publicaciones-formacion;Fiscal-Contable
user4@example.com;Max;Mustermann;1;actividad;publicaciones-formacion;Fiscal-Contable</pre>{* Output format. *}
                        ...
                        <div class="content-navigation-childlist overflow-table">
                                ...
                                <table class="list" cellspacing="0">
                                    <tr>
                                        ...
                                        <th class="tight">
                                            {'Actividad'|i18n( 'cjw_newsletter/subscription_list_csvimport' )}
                                        </th>
                                         <th class="tight">
                                            {'Desea información sobre'|i18n( 'cjw_newsletter/subscription_list_csvimport' )}
                                        </th>
                                         <th class="tight">
                                            {'Materias'|i18n( 'cjw_newsletter/subscription_list_csvimport' )}
                                        </th>
                                        <th class="tight">
                                    ...
                                    {foreach $csv_data_array as $row => $data_set max $limit offset $view_parameters.offset}
                                        ...
                                        <tr>
                                            ...
                                            <td title="{if is_object($user_object)}{$user_object.organisation|wash}{$user_object.organisation|wash}{/if}">
                                                {$data_set.organisation|wash}
                                                {if is_object($user_object)}
                                                    -&gt; {$user_object.organisation|wash}
                                                {/if}
                                            </td>
                                            <td title="{if is_object($user_object)}{$user_object.about_info|wash}{$user_object.about_info|wash}{/if}">
                                                {$data_set.about_info|wash}
                                                {if is_object($user_object)}
                                                    -&gt; {$user_object.about_info|wash}
                                                {/if}
                                            </td>
                                             <td title="{if is_object($user_object)}{$user_object.about_materia|wash}{$user_object.about_materia|wash}{/if}">
                                                {$data_set.about_materia|wash}
                                                {if is_object($user_object)}
                                                    -&gt; {$user_object.about_materia|wash}
                                                {/if}
                                            </td>

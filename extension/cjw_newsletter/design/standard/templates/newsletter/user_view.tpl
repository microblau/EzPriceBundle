                        ...
                        <div class="block float-break">
                            <table class="list">
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    <th>
                                        {'Desea recibir informacion sobre :'|i18n( 'cjw_newsletter/user_view' )}
                                    </th>
                                    <td title="{$newsletter_user.salutation|wash}">
                                        {$newsletter_user.about_info|wash}
                                    </td>
                                </tr>
                                 <tr>
                                    <th>
                                        {'Desea recibir informacion sobre las materias: '|i18n( 'cjw_newsletter/user_view' )}
                                    </th>
                                    <td title="{$newsletter_user.salutation|wash}">
                                        {$newsletter_user.about_materia|wash}
                                    </td>
                                </tr>
                                <tr>
                                    <th>
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    <th>
                                        {'Ebook descargado'|i18n( 'cjw_newsletter/user_view' )}
                                    </th>
                                    <td>
                                        {def $ebook = fetch( 'newsletter', 'ebook_by_hash', hash( 
                                                                                        'hash', $newsletter_user.hash|wash
                                                                                    ) ))}
                                             {$ebook}
                                        {undef $ebook}
                                    </td>

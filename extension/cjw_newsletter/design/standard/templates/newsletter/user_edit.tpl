                    ...
                    <div class="context-attributes">
                        <div class="block float-break">
                            <table class="list">
                               ...
                               <tr>
                                    <th>
                                        {'Actividad'|i18n( 'cjw_newsletter/user_view' )}
                                    </th>
                                    <td>
                                        <input class="halfbox" type="text" name="organisation" value="{$newsletter_user.organisation|wash}" title="{'organisation'|i18n( 'cjw_newsletter/user_edit' )}"
                                    </td>
                                </tr>
                                <tr>
                                    <th>
                                        {'About_info'|i18n( 'cjw_newsletter/user_view' )}
                                    </th>
                                    <td>
                                        <input class="halfbox" type="text" name="about_info" value="{$newsletter_user.about_info|wash}" title="{'about_info'|i18n( 'cjw_newsletter/user_edit' )}"
                                    </td>
                                </tr>
                                <tr>
                                    <th>
                                        {'About_materia'|i18n( 'cjw_newsletter/user_view' )}
                                    </th>
                                    <td>
                                        <input class="halfbox" type="text" name="about_materia" value="{$newsletter_user.about_materia|wash}" title="{'about_materia'|i18n( 'cjw_newsletter/user_edit' )}"
                                    </td>
                                </tr>

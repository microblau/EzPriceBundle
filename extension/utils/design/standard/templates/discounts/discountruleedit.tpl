<script type="text/javascript" src={"javascript/jquery-ui-1.7.2.custom.min.js"|ezdesign(no)} charset="utf-8"></script>
<script type="text/javascript" src={"javascript/ui.datepicker-es.js"|ezdesign(no)} charset="utf-8"></script>
<link rel="stylesheet" type="text/css" href={"stylesheets/jquery-ui-1.7.2.custom.css"|ezdesign()} />
...
<div class="block">
<fieldset>
<legend>{'Fechas de validez}</legend>




<label>Inicio<br/>
<input type="text" name="start" value="{$start}" class="fecha" />
</label>
<label>Fin<br/>
<input type="text" name="end" value="{$end}" class="fecha"  />
</label>

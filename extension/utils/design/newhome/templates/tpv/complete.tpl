...
<form enctype="multipart/form-data" method="post" action={concat("tpv/complete/", $order_id )|ezurl()}>
{/if}
                                ...
                                <div class="wrap clearFix curvaFondo">                    		
							        <div class="description">
                            	        <div class="cont" style="padding:20px;">
                                            <form action={concat( "tpv/complete/", $id)|ezurl} method="post" id="finCompraForm" class="formulario conocer" name="finCompraForm">

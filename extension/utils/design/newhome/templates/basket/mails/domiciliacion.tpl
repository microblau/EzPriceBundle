                    ...
                    <td>
                        <table width="590" cellpadding="0" cellspacing="0" bgcolor="#00528d">
                            ...
                            <tr>
                                ...
                                <td width="189"><a href="http://{ezsys( 'hostname' )}{"/"|ezurl(no)}"><img  src="http://{ezsys( 'hostname' )}/{"mail/logo_efl.gif"|ezimage(no, true())}"  border="0"/></a></td>
...
<p>El Pedido {$id} se ha realizado con éxito el día {currentdate()|datetime( 'custom', '%d/%m/%Y')}</p>

<p>Ha seleccionado como modo de pago DOMICILIACIÓN BANCARIA, en la cuenta <b>{$info.banco} {$info.sucursal} {$info.control} {$info.ncuenta}</b>. cuyo titular es {$info.titular_cuenta}.</p>
...
{$product.object_name}<br />
 ...
 {elseif $product.item_object.contentobject.contentclass_id|eq(149)}
{$product.object_name}<br />
 <span style="font-size:11px; font-weight:normal">{$info.has_imemento.mementos}.</span> 
{elseif $product.item_object.contentobject.contentclass_id|eq(145)}
{$product.object_name}<br />
 <span style="font-size:11px; font-weight:normal">{$info.has_imemento.mementos}.</span>   
{else}
                                                                ...
                                                                {/if}
                                                                                                    ...
                                                                                                    <tr><td colspan="5" height="24" bgcolor="#ffffff" style="font-family:Arial, Helvetica, sans-serif; font-size:1px; line-height:1px;">&nbsp;</td></tr>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td bgcolor="#ffffff" style="font-family:Arial, Helvetica, sans-serif; font-size:1px; line-height:1px;">&nbsp;</td>
                                                                                                            <td colspan="2" bgcolor="#ffffff" align="right" style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#333333;">TOTAL (sin IVA)</td>
                                                                                                            <td colspan="2" bgcolor="#ffffff" align="right" style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#333333; font-weight:bold">{$basket.total_ex_vat|l10n( clean_currency )} €</td>
                                                                                                        </tr>
                                                                                                        <tr>
                                                                                                            <td bgcolor="#ffffff" style="font-family:Arial, Helvetica, sans-serif; font-size:1px; line-height:1px;">&nbsp;</td>
                                                                                                            <td colspan="2" bgcolor="#ffffff" align="right" style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#333333; font-weight:bold;">TOTAL</td>

							...
							<div class="wrap clearFix">                    		
									<div class="description">
										<div id="datosFacturacion">
                                        	...
                                        	{/if}
                                            <form action={"basket/register"|ezurl} method="post" id="datosFacturacionForm" name="datosFacturacionForm" class="formulario empresa">
                                            <span class="camposObligatorios">* Datos obligatorios</span>
                                                ...
                                                <ul class="datos">
                                                    <li>
                                   	               ...
                                   	               <li {if is_set($errors.empresa)}class="error"{/if}>
                                                        ...
                                                        <input type="text" id="empresa" name="empresa" class="text" value="{cond( is_set( $empresa ), $empresa, '' )}" />
                                                    </li> 
                                                    <li {if is_set($errors.cif)}class="error"{/if}>
                                                    	<label for="cif">CIF *</label>
                                                        <input type="text" id="cif" name="cif" class="text" value="{cond( is_set( $cif ), $cif, '' )}" />
                                                        <span>B00000000</span>
                                                    ...
                                                    <li {if is_set($errors.telefonoEmp)}class="error"{/if}>
                                                        ...
                                                        <input type="text" id="telefonoEmp" name="telefonoEmp" class="text" value="{cond( is_set( $telefonoEmp ), $telefonoEmp, '' )}" />
                                                    </li> 
                                                    ...
                                                    {*<li class="contacto">
                                                    	<fieldset>
                                                    		<legend><span>¿Va a actuar como persona de contacto? *</span></legend>
                                                    		                                              														<div>			
                                                    				<label for="sicContacto"><input type="radio" name="personaContacto" id="sicContacto" value="si" {if or( is_set( $personaContacto )|not, and(  is_set( $personaContacto ), $personaContacto|eq('si') ) )}checked="checked"{/if}/> Sí</label>

                                                    				<label for="nocContacto"><input type="radio" name="personaContacto" id="nocContacto" value="no" {if and(  is_set( $personaContacto ), $personaContacto|eq('no') ) }checked="checked"{/if}/> No</label>
                                                    				</div>  
                                                ...
                                                <fieldset>
                                                	...
                                                	<legend><span>¿Los datos de envío coinciden con los datos de facturación?</span></legend>
                                                		<div>
                                                		<label for="si"><input type="radio" id="si" name="datos" value="si" {if or( is_set( $datos_coinciden)|not, $datos_coinciden|ne( 'no' ) )}checked="checked"{/if} /> Sí  </label>
                                                      <label for="no"><input type="radio" id="no" name="datos" value="no" {if or( is_set( $datos_coinciden)|not, $datos_coinciden|ne( 'no' ) )|not}checked="checked"{/if} />No</label>
                                                      </div>                                                       
                                                </fieldset>
                                                ...
                                                <ul class="datos {if or( is_set( $datos_coinciden)|not, $datos_coinciden|ne( 'no' ) )} hide"{/if}">
                                                    ...
                                                    <li {if is_set($errors.movil2)}class="error"{/if}>
                                                     ...
                                                     <li>
                                                        ...
                                                        <input type="text" id="email2" name="email2" class="text" value="{cond( is_set( $mail2 ), $mail2, '' )}"/>
                                                    </li> 
                                                    {*
                                                     <li>
                                               ...
                                               <div class="clearFix">
	                                               {* <span class="volver"><a href="">Volver</a></span>*}
   	                                             <span class="submit"><input type="image" src={"btn_continuar.gif"|ezimage} alt="Continuar" name="BtnRegisterEmpresa" /></span>

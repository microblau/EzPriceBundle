...
$object = eZContentObject::fetch( eZINI::instance( 'qmementix.ini' )->variable( 'Qmementix', 'Object' ) );
$data = $object->dataMap();
...
foreach ( $collectionItems as $item )
{
    ...
    if ( $item['contentobject_id'] ==  eZINI::instance( 'qmementix.ini' )->variable( 'Qmementix', 'Object' ) )
    {
...
if ( $itemID )
    {
          ...
          $item->setAttribute( 'name', 'Qmementix'  );
...
else
    {
        ...
        $item->setAttribute( 'name', 'Qmementix'  );
        $item->setAttribute( "contentobject_id",  eZINI::instance( 'qmementix.ini' )->variable( 'Qmementix', 'Object' ));
        $item->setAttribute( "item_count", 1 );

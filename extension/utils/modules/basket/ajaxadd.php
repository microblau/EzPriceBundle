...
$OptionList = count( $http->sessionVariable( "AddToBasket_OptionList_" . $ObjectID )  ) ? $http->sessionVariable( "AddToBasket_OptionList_" . $ObjectID ) : array() ;
...
$url = 'basket/basket';
$utilsini = eZINI::instance();
$domain = $utilsini->variable( 'EFLSettings',  'WWWSubdomain' );

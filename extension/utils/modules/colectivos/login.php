...
$tpl->setVariable( 'warning', array( 'bad_login' => $loginWarning ) );

$tpl->setVariable( 'site_access', array( 'allowed' => $siteAccessAllowed,
                                         'name' => $siteAccessName ) );
$tpl->setVariable( 'user_is_not_allowed_to_login', $userIsNotAllowedToLogin );
$tpl->setVariable( 'failed_login_attempts', $failedLoginAttempts );
$tpl->setVariable( 'max_num_of_failed_login', $maxNumOfFailedLogin );


$Result = array();
$Result['content'] = $tpl->fetch( 'design:colectivos/login.tpl' );

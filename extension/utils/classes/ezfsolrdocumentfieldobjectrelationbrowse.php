 ...
 * querying for the ezobjectrelation and ezobjectrelationbrowse in eZFind.
 *
 * @package eZFind
 */

class ezfSolrDocumentFieldObjectRelationBrowse extends ezfSolrDocumentFieldBase
{
    /**
     ...
     *
     * @param eZContentClassAttribute $classAttribute The ezobjectrelation/ezobjectrelationbrowse attribute
     ...
     * default, full-text search field for an ezobjectrelation/ezobjectrelationbrowse
     * content object attribute.
     *
     * @return string The string representation of the related eZContentObject(s),
     *                then indexed in Solr.
     * @param eZContentObjectAttribute $contentObjectAttribute The ezobjectrelation/ezobjectrelationbrowse
                ...
                if ( $relatedObject )
                {
                    ...
                    foreach( $baseList as $field )
                    {
                        ...
                        if ( $tmpClassAttribute->attribute( 'data_type_string' ) == 'ezobjectrelation' or
                             $tmpClassAttribute->attribute( 'data_type_string' ) == 'ezobjectrelationbrowse' )
                        {

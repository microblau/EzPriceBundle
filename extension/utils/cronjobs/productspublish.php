...
{
    $newVersion = $node->attribute( 'object' )->createNewVersion();
	 $operationResult = eZOperationHandler::execute( 'content', 'publish', array( 'object_id' => $node->attribute('object')->attribute( 'id' ),
